...
let word = prompt("Introduce one word","");
let menu1 = prompt("Replace chars by sings? y | n");
let menu2 = prompt("Capitalize? y | n");
let menu3 = prompt("Replace speces with commas? y | n");
let props = {
    replaceChars: false,
    capitalize: false,
    replaceSpaces: false
